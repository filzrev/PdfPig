...
public class NonAsciiCharactorsBookmarksTests
{
    [Theory]
    ...
    public void TestBookmarksTests(string words)
    {
        ...
        builder.Bookmarks = new Bookmarks(inputs.Select(x => new DocumentBookmarkNode(x, 0, new ExplicitDestination(1, ExplicitDestinationType.XyzCoordinates, ExplicitDestinationCoordinates.Empty), Array.Empty<BookmarkNode>())).ToArray());
